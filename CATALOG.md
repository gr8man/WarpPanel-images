...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **PHP 8.0** | `20260831` | `PHP-FPM Modern` | `php:8.0-fpm-alpine` | `ghcr.io/gr8man/php:8.0-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.0/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 8.1** | `20260831` | `PHP-FPM Modern` | `php:8.1-fpm-alpine` | `ghcr.io/gr8man/php:8.1-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.1/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 8.2** | `20260831` | `PHP-FPM Modern` | `php:8.2-fpm-alpine` | `ghcr.io/gr8man/php:8.2-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.2/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 8.3** | `20260831` | `PHP-FPM Modern` | `php:8.3-fpm-alpine` | `ghcr.io/gr8man/php:8.3-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.3/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 8.4** | `20260831` | `PHP-FPM Modern` | `php:8.4.25-fpm-alpine3.23` | `ghcr.io/gr8man/php:8.4-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.4/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 8.5** | `20260831` | `PHP-FPM Modern` | `php:8.5-fpm-alpine` | `ghcr.io/gr8man/php:8.5-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/8.5/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 5.6** | `20260831` | `PHP-FPM Legacy` | `php:5.6-fpm-alpine` | `ghcr.io/gr8man/php:5.6-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/5.6/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 7.0** | `20260831` | `PHP-FPM Legacy` | `php:7.0-fpm-alpine` | `ghcr.io/gr8man/php:7.0-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/7.0/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 7.1** | `20260831` | `PHP-FPM Legacy` | `php:7.1-fpm-alpine` | `ghcr.io/gr8man/php:7.1-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/7.1/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 7.2** | `20260831` | `PHP-FPM Legacy` | `php:7.2-fpm-alpine` | `ghcr.io/gr8man/php:7.2-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/7.2/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 7.3** | `20260831` | `PHP-FPM Legacy` | `php:7.3-fpm-alpine` | `ghcr.io/gr8man/php:7.3-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/7.3/20260831.json) | ✅ **VERIFIED (PASS)** |
| **PHP 7.4** | `20260831` | `PHP-FPM Legacy` | `php:7.4-fpm-alpine` | `ghcr.io/gr8man/php:7.4-fpm-alpine-20260831` | [📄 Specyfikacja 20260831](catalog/current/php-fpm/7.4/20260831.json) | ✅ **VERIFIED (PASS)** |
