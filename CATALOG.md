...
> **Ostatnia aktualizacja:** `2026-08-28T22:42:21+00:00`
...
| **PHP 8.3** | `modern` | `php:8.3.17-fpm-alpine3.21` | `8.3-fpm-alpine`, `8.3-fpm`, `latest-fpm` | `ghcr.io/warppanel/php:8.3-fpm-alpine` | ✅ **VERIFIED (PASS)** |
